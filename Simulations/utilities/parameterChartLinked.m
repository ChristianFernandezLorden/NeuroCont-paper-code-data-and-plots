function out_val = parameterChartLinked(params, var_params, model, link_fct, eval_params, nb_par)
    ...
    while nb_simed < total_sim
        ...
        for j = 1:nb_sim
            ...
            for k = 1:length(updatable_params_fields)
                ...
                tmp_params.(name) = vec_param(pos(k));
            end

            cur_params = link_fct(cur_params, tmp_params);
